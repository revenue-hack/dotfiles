...
INSERT INTO `courses` (`id`, `course_type`, `title`, `description`, `is_required`, `category_id`, `status`, `created_by`, `created_at`, `updated_by`)
VALUES
    (1, 1, 'e-Learning 1', '', 0, 1, 1, 1, @createdAt, 1),
    (2, 1, 'e-Learning 2', '', 1, 2, 2, 1, @createdAt, 1),
    (3, 2, '集合研修 1', '', 0, 1, 1, 1, @createdAt, 1),
    (4, 2, '集合研修 2', '', 1, 2, 2, 1, @createdAt, 1);
